					...
					<div class="mt-10 flex flex-col items-center justify-center gap-x-6">
						{#if !submitted}
							<input
								...
								bind:value={email}
								placeholder="Email"
								class="w-64 p-4 border text-center border-blue-100 text-slate-600 font-semibold text-lg rounded-lg shadow-sm"
							/>
							<button
								on:click={onClick}
								class="rounded-md bg-indigo-600 mt-6 px-5 py-4 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
								>Get started</button
							>
						{:else}
